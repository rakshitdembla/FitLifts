...
import 'package:fitlifts/data/models/exercise.dart' as _i20;
...
class ExercisesViewRoute extends _i18.PageRouteInfo<ExercisesViewRouteArgs> {
  ExercisesViewRoute({
    ...
    required List<_i20.Exercise> exercisesList,
...
class ExercisesViewRouteArgs {
  ...
  final List<_i20.Exercise> exercisesList;
...
class SearchExerciseRoute extends _i18.PageRouteInfo<SearchExerciseRouteArgs> {
  SearchExerciseRoute({
    _i19.Key? key,
    required List<List<_i20.Exercise>> allExercises,
    List<_i18.PageRouteInfo>? children,
  }) : super(
...
class SearchExerciseRouteArgs {
  ...
  final List<List<_i20.Exercise>> allExercises;
...
/// generated route for
/// [_i13.TrackingAccuracyPage]
class TrackingAccuracyPageRoute extends _i18.PageRouteInfo<void> {
  const TrackingAccuracyPageRoute({List<_i18.PageRouteInfo>? children})
  ...
  static _i18.PageInfo page = _i18.PageInfo(
    name,
    builder: (data) {
      return const _i13.TrackingAccuracyPage();
    },
  );
}
...
class UnlockPremiumRoute extends _i18.PageRouteInfo<void> {
  ...
  static _i18.PageInfo page = _i18.PageInfo(
    name,
    builder: (data) {
      return const _i14.UnlockPremium();
    },
  );
}
...
class UpdateProfilePageRoute
    extends _i18.PageRouteInfo<UpdateProfilePageRouteArgs> {
